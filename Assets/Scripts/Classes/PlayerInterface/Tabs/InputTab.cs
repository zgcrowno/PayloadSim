...
public class InputTab : SubTab {
    ...
    public override void Draw()
    {
        ...
        textHeight = inputStyle.CalcHeight(new GUIContent(prevInputs + inputField.input), textRect.width);
        ...
        if(!beingDragged)
        {
            //input = GUI.TextArea(textRect, input, inputStyle);
            inputField.Draw();
            GUI.Label(textRect, prevInputs, prevInputsStyle);
        }
