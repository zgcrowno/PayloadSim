...
public class SubTab : Tab {
    ...
    public Rect[] quadrants = new Rect[4]; //The left, right, middle-top and middle-bottom quadrants by which is determined the placement of subsequent SubTabs within the overarching SuperTab
    public Rect[] resizeRects = new Rect[8]; //The left, right, top, bottom, bottom-left, top-left, top-right and bottom-right rects within which the mouse cursor will change to one of four different resize cursors
