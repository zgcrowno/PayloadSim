...
public class HelpTab : TextListTab {
	...
	new public void Start() {
        ...
        for(int i = 0; i < 10; i++)
        {
            GameObject collapsibleListItem = Instantiate(Resources.Load("Prefabs/CollapsibleListItemPrefab") as GameObject);
            ...
            if(i < 9)
            {
                GameObject contentTextObject = Instantiate(Resources.Load("Prefabs/TextPrefab") as GameObject);
            ...
            {
                GameObject contentListObject = Instantiate(Resources.Load("Prefabs/CollapsibleListPrefab") as GameObject);
                ...
                GameObject newCollapsibleListItem = Instantiate(Resources.Load("Prefabs/CollapsibleListItemPrefab") as GameObject);
                ...
                GameObject newContentTextObject = Instantiate(Resources.Load("Prefabs/TextPrefab") as GameObject);
